...
{	
	...
	function get_comingorder($num,$offset, &$row_count)
	{
		try{
			...
			$sql = "SELECT SQL_CALC_FOUND_ROWS o.*,o.order_id,o.order_ref,o.order_date,u.name,u.email,o.order_status,o.week_status,
					...
					WHERE dl.order_date = '".$day."' AND o.week_num > o.week_status AND o.order_status = 'On-going' 
					 LIMIT ";
	...
	function pdf_addition($id,$day)
	{
		try{
			...
			$sql = "SELECT i.name,d.item_qty,i.price,(i.price*d.item_qty) AS amount
					...
					WHERE (o.item_subscription = 'YES' OR (o.item_subscription = 'NO' && o.additional_item_status = 'YES' &&  
	...
	function get_deliver_order($num,$offset, &$row_count)
	{		
		try{
			...
			$sql = "SELECT  SQL_CALC_FOUND_ROWS o.order_id,o.order_ref,o.order_date,u.name,u.email,o.order_status,o.week_status,o.week_num,DATE_FORMAT(dl.order_date,'%d-%m-%Y') AS order_delivery_date,
					...
					AND dl.order_date <= '".$cday."' AND dl.delivery_date IS NULL ORDER BY dl.order_date DESC LIMIT ";
