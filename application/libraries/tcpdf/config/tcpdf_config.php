...
define ('K_PATH_URL', $_SERVER['DOCUMENT_ROOT']);
 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define ('K_PATH_IMAGES', K_PATH_URL.'vegybox/assets/img/');
...
define ('PDF_HEADER_LOGO', 'pdf-header.jpg');

/**
 * Header logo image width in user units.
 */
define ('PDF_HEADER_LOGO_WIDTH', 190);
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'FRESCO');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "by Ace");
